...
if __name__ == '__main__':
    ...
    R_list = [500, 1000, 1500, 2000, 2500, 3000]
    data = np.zeros((len(R_list), 50))
    ...
    for l, R in enumerate(R_list):
        plt.plot(range(1,num_syn_max), data[l, :num_syn_max-1], label=str(R))

    plt.xticks(range(num_syn_max))
